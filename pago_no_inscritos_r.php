...
<body>
    ...
    <header id="main-header">
        ...
        <nav class="bottom-nav">
            <div class="nav-item">
                <a href="pago_no_inscritos_f.php?dinero=<?php echo urlencode($dinero); ?>&producto_destino=<?php echo urlencode($producto_destino); ?>&producto_origen=<?php echo urlencode($producto_origen); ?>&tipo_destino=<?php echo urlencode($tipo_destino); ?>&nombre_personalizado=<?php echo urlencode($nombre_personalizado); ?>&descripcion=<?php echo urlencode($descripcion); ?>">
