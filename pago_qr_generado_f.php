    ...
    <header id="main-header">
        ...
        <main class="main-content">
            ...
            <form action="pago_qr_generado_r.php" method="post" autocomplete="off">
                ...
                <p><input class="rdm-formularios--input-grande" type="text" id="descripcion" name="descripcion" value="<?php echo isset($_GET['descripcion']) ? htmlspecialchars($_GET['descripcion']) : ''; ?>" placeholder="Descripción del QR" ></p>
                <br>
