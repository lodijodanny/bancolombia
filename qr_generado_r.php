...
// Función para generar un número de comprobante aleatorio
function generarComprobante() {
    $caracteres = '0123456789abcdef'; // Caracteres hexadecimales válidos
    $longitud = 12; // Longitud del comprobante
    $comprobante = '';
    for ($i = 0; $i < $longitud; $i++) {
        $comprobante .= $caracteres[rand(0, strlen($caracteres) - 1)];
    }
    return $comprobante;
}

// Generar comprobante aleatorio
$comprobante_no = generarComprobante();
