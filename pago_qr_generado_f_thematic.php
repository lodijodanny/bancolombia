    ...
    <header id="main-header">
        ...
        <main class="main-content">
            ...
            <form action="pago_qr_generado_r.php" method="post" autocomplete="off">
                ...
                <p class="rdm-formularios--label"><label for="descripcion">Descripción del QR</label></p>
                <p><input class="rdm-formularios--input-grande" type="text" id="descripcion" name="descripcion" value="<?php echo isset($_GET['descripcion']) ? htmlspecialchars($_GET['descripcion']) : 'THEMATIC SUITES'; ?>" placeholder="Descripción del QR" ></p>
                <br>

                <p class="rdm-formularios--label"><label for="nombre_personalizado">Nombre personalizado</label></p>
                <p><input class="rdm-formularios--input-grande" type="text" id="nombre_personalizado" name="nombre_personalizado" value="<?php echo isset($_GET['nombre_personalizado']) ? htmlspecialchars($_GET['nombre_personalizado']) : 'MARINA ESTER ROZO DE'; ?>" placeholder="Nombre personalizado" ></p>
                <br>
                ...
                <p><input class="rdm-formularios--input-grande" type="number" id="producto_destino" name="producto_destino" value="<?php echo isset($_GET['producto_destino']) ? htmlspecialchars($_GET['producto_destino']) : '00554503241'; ?>" placeholder="#" ></p>
                <br>
		        ...
		        <p><select class="rdm-formularios--input-grande" id="tipo_destino" name="tipo_destino" >
		            <option value="Ahorros" <?php echo (isset($_GET['tipo_destino']) && $_GET['tipo_destino'] == 'Ahorros') ? 'selected' : 'selected'; ?>>Ahorros</option>
