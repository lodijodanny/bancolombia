    ...
    <header id="main-header">
        ...
        <main class="main-content">
            ...
            <form action="pago_no_inscritos_r.php" method="post" autocomplete="off">
                ...
                <p><input class="rdm-formularios--input-grande" type="number" id="producto_destino" name="producto_destino" value="<?php echo isset($_GET['producto_destino']) ? htmlspecialchars($_GET['producto_destino']) : ''; ?>" placeholder="#" required></p>
                <br>
