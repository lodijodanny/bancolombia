    ...
    <header id="main-header">
        ...
        <main class="main-content">
            ...
            <form action="pago_no_inscritos_r.php" method="post" autocomplete="off">
                ...
                <p><input class="rdm-formularios--input-grande" type="number" id="producto_destino" name="producto_destino" value="27236964251" placeholder="#" required></p>
                <br>
                ...
                <p><input class="rdm-formularios--input-grande" type="text" id="nombre_personalizado" name="nombre_personalizado" value="Eric Jesse Cuervo Giraldo" placeholder="Nombre personalizado" required></p>
                <br>
