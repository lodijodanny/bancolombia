    ...
    <header id="main-header">
        ...
        <main class="main-content">
            ...
            <form action="pago_breb_r.php" method="post" autocomplete="off">
                ...
                <p><input class="rdm-formularios--input-grande" type="text" id="punto_venta" name="punto_venta" value="PERGAMINO ARKADIA" placeholder="Punto de venta" required></p>
                <br>                

                <p class="rdm-formularios--label"><label for="codigo_negocio">Código de negocio</label></p>
                <p><input class="rdm-formularios--input-grande" type="number" id="codigo_negocio" name="codigo_negocio" value="0081023277" placeholder="#" required></p>
                <br>
